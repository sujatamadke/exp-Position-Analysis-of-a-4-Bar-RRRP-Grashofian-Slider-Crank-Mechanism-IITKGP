...
function CrankRotator12(sliderVal) {
	...
	if (d>0) {
		...
		if (document.getElementById("th12x").checked==true ) {
			...
			if (document.getElementById("s41y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((th12*180/Math.PI)*c2d.width/720), -Math.round((s41*180/(l2+l3+l4))*c2d.height/720), 2, 0, 2 * Math.PI, false);
		...
		if (document.getElementById("th23x").checked==true ) {
			...
			if (document.getElementById("s41y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((th23*180/Math.PI)*c2d.width/720), -Math.round((s41*180/(l2+l3+l4))*c2d.height/720), 2, 0, 2 * Math.PI, false);
				ctx.fillStyle = "rgb(128, 0, 127)";
				ctx.fill();
			}
		}
		if (document.getElementById("s41x").checked==true ) {
			...
			if (document.getElementById("th12y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((s41*100/(l2+l3+l4))*c2d.height/720), -Math.round((th12*180/Math.PI)*c2d.height/720), 2, 0, 2 * Math.PI, false);
				ctx.fillStyle = "rgb(127, 64, 64)";
				ctx.fill();
			}
			if (document.getElementById("th23y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((s41*100/(l2+l3+l4))*c2d.height/720), -Math.round((th23*180/Math.PI)*c2d.height/720), 2, 0, 2 * Math.PI, false);
				ctx.fillStyle = "rgb(64, 127, 64)";
				ctx.fill();
			}
			if (document.getElementById("s41y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((s41*100/(l2+l3+l4))*c2d.height/720), -Math.round((s41*100/(l2+l3+l4))*c2d.height/720), 2, 0, 2 * Math.PI, false);
...
function CrankRotator41(sliderVal) {
	...
	th1=0.0;
	s41=sliderVal;
	a=2.0*l2*(s41*Math.cos(th4)+l4*Math.sin(th4));
	b=2.0*l2*(s41*Math.sin(th4)-l4*Math.cos(th4));
	c=l3*l3-s41*s41-l2*l2-l4*l4;
	d=a*a+b*b-c*c;
	if (d>0) {
		...
		if (document.getElementById("th12x").checked==true ) {
			...
			if (document.getElementById("s41y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((th12*180/Math.PI)*c2d.width/720), -Math.round((s41*100/(l2+l3+l4))*c2d.height/720), 2, 0, 2 * Math.PI, false);
				ctx.fillStyle = "rgb(0, 0, 255)";
				ctx.fill();
			}
		}
		if (document.getElementById("th23x").checked==true ) {
			...
			if (document.getElementById("s41y").checked==true ) {		
				ctx.beginPath();
				ctx.arc(Math.round((th23*180/Math.PI)*c2d.width/720), -Math.round((s41*100/(l2+l3+l4))*c2d.height/720), 2, 0, 2 * Math.PI, false);
				ctx.fillStyle = "rgb(128, 0, 127)";
				ctx.fill();
			}
		}
...
function CrankRotator23(sliderVal) {
	...
	d=l2*l2-(l3*Math.sin(th4-th3)-l4)*(l3*Math.sin(th4-th3)-l4);
	if (d>0) {
		s41=l3*Math.cos(th4-th3)+toggle*Math.sqrt(d);
		th2=Math.atan2(s41*Math.sin(th4)-l3*Math.sin(th3)-l4*Math.cos(th4), s41*Math.cos(th4)-l3*Math.cos(th3)+l4*Math.sin(th4));
		th12=th2-th1;
		th23=th3-th2;
		th34=-Math.PI/2+th4-th3;
		th41=th1-th4;
